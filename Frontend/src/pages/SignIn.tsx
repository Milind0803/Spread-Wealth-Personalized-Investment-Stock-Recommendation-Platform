    ...
    <div className="min-h-screen bg-gray-50 flex flex-col justify-center py-12 sm:px-6 lg:px-8">
      <div className="sm:mx-auto sm:w-full sm:max-w-md">
        ...
        <p className="mt-2 text-center text-sm text-gray-600">
          ...
          {" | "}
          <Link to="/stock-prices" className="font-medium text-finance-blue hover:text-blue-800 transition-colors duration-300 flex items-center justify-center gap-1">
              ...
              <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
                ...
                <div className="flex items-center justify-end">
                  <div className="text-sm">
                    <a href="#" className="font-medium text-finance-blue hover:text-blue-800">
                ...
                <Button 
                  type="submit" 
                  className="w-full bg-finance-blue hover:bg-blue-800"
